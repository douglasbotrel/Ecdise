        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          ...
          {process.env.NODE_ENV === 'development' && (
            <div className="mt-6 p-4 bg-gray-50 rounded-xl border border-gray-200">
              <p className="text-xs font-semibold text-gray-500 mb-2">Credenciais de desenvolvimento:</p>
              <div className="space-y-1 text-xs text-gray-600">
                <div className="flex gap-2">
                  <span className="font-medium">Admin:</span>
                  <button
                    onClick={() => { setEmail('admin@ecdise.com'); setSenha('admin@ecdise2024') }}
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={() => { setEmail('gestor@ecdise.com'); setSenha('gestor@ecdise2024') }}
                    className="text-green-600 hover:underline"
                  >
                    gestor@ecdise.com
                  </button>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={() => { setEmail('analista@ecdise.com'); setSenha('analista@ecdise2024') }}
                    className="text-green-600 hover:underline"
                  >
                    analista@ecdise.com
                  </button>
